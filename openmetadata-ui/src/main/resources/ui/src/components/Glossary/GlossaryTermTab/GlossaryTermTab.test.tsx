...
describe('Test GlossaryTermTab component', () => {
  ...
  describe('Task Management and Status Actions', () => {
    ...
    it('should keep the term in review when an approval vote is recorded but the task stays open', async () => {
      ...
      // Let the initial terms-page fetch settle before clearing mocks, else
      // its own (unrelated) setGlossaryChildTerms call can land after the
      // clear and be mistaken for one triggered by the approve click below.
      await waitFor(() => {
